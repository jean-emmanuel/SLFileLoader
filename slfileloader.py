...
directories = [
    '/home/bordun/Downloads/', # Loop 1 audio files
    '/home/bordun/Downloads/', # Loop 2 audio files
...
class Gui(wx.Frame):
    def __init__(self, parent=None, title='SL File Loader', pos=(100,100), size=(444,2+82*n_loop)):
        ...
        self.loop_durations, self.loops, self.labels, self.selectors, self.prev_buttons, self.next_buttons, self.load_buttons, self.gauges, self.trig_buttons, self.once_buttons, self.mute_buttons, self.pause_buttons, self.volume_sliders, self.volume_labels = list(range(n_loop)), [], [], [], [], [], [], [], [], [], [], [], [], []
